...
export default async function middleware(request: NextRequest) {
    ...
    const sessionToken = sessionStorage.getItem('session_token');  // Get session token from cookies
    const refreshToken = sessionStorage.getItem('refresh_token');  // Get refresh token from cookies
