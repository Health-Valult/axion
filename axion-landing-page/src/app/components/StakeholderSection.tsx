...
import { 
  ...
  const stakeholders = [
    {
      title: "Patients",
      description: "Access medical records, get health updates, and manage medication reminders seamlessly through web and mobile.",
      icon: UserCircle,
    ...
    {
      title: "Hospitals",
      description: "Efficiently manage and upload patient records while maintaining secure access to comprehensive medical histories.",
      icon: Hospital,
    ...
    {
      title: "Doctors",
      description: "Review patient histories, prescribe medications, and monitor health progress through detailed analytics.",
      icon: Stethoscope,
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Powerful features designed specifically for patients, hospitals, and doctors
            </p>
          </div>
