...
export default function App() {
  const diagnosis: DiagnosisRecord[] = [
    {
      ...
      "history": [
        ...
        {
          "date": "2023-01-10",
          "diagnosis_update": "Started Insulin (Long-Acting) at 10 units/day",
          "doctor": "Dr. Williams"
        }
      ]
    },
  ...
  return (
    <div className="p-4 sm:ml-64 mt-14 flex flex-col min-h-[calc(100vh-56px)]">
      <h5 className="m-6 text-xl font-extrabold tracking-tight leading-none text-gray-900 md:text-lg lg:text-xl">Patient's long-term diagnosed illenesses</h5>
