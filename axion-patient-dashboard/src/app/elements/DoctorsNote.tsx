...
export const DoctorsNote = ({name, dateTime, indication, content, treatment}: {name: string, dateTime: string, indication:string,content: string, treatment: string[]}) => {
