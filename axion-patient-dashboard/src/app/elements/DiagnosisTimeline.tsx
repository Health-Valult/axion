  ...
  return (
    <div className="p-4 bg-gray-100 border border-gray-300 rounded-md">
      <ol className="items-center sm:flex">
            {illness.history.map((date) => (
                <li key={date.diagnosis_update} className="relative mb-6 sm:mb-0">
                    ...
                    <div className="mt-3 sm:pe-8">
                        <h3 className="text-lg font-semibold text-gray-900 ">{date.diagnosis_update}</h3>
                        <time className="block mb-2 text-sm font-normal leading-none text-gray-400 ">{date.date}</time>
                        <p className="text-base font-normal text-gray-500 ">{date.doctor}</p>
                    </div>
                </li>
            ))}
