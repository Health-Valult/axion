...
part of 'serum_creatinine_report.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class SerumCreatinineReportAdapter extends TypeAdapter<SerumCreatinineReport> {
  @override
  final int typeId = 10;

  @override
  SerumCreatinineReport read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return SerumCreatinineReport(
      ...
      creatinineValue: fields[11] as String,
  ...
  @override
  void write(BinaryWriter writer, SerumCreatinineReport obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is SerumCreatinineReportAdapter &&
