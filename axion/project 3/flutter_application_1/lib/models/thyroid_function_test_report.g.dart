...
part of 'thyroid_function_test_report.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ThyroidFunctionTestReportAdapter
    extends TypeAdapter<ThyroidFunctionTestReport> {
  @override
  final int typeId = 8;

  @override
  ThyroidFunctionTestReport read(BinaryReader reader) {
    ...
    return ThyroidFunctionTestReport(
      ...
      t3: fields[11] as String,
      t4: fields[12] as String,
      tsh: fields[13] as String,
    );
  }

  @override
  void write(BinaryWriter writer, ThyroidFunctionTestReport obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is ThyroidFunctionTestReportAdapter &&
