...
part of 'serum_chloride_report.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class SerumChlorideReportAdapter extends TypeAdapter<SerumChlorideReport> {
  @override
  final int typeId = 2;

  @override
  SerumChlorideReport read(BinaryReader reader) {
    ...
    return SerumChlorideReport(
      ...
      chlorideValue: fields[11] as String,
  ...
  @override
  void write(BinaryWriter writer, SerumChlorideReport obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is SerumChlorideReportAdapter &&
