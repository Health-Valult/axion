...
part of 'esr_wintrobe_report.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ESRWintrobeReportAdapter extends TypeAdapter<ESRWintrobeReport> {
  @override
  final int typeId = 11;

  @override
  ESRWintrobeReport read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, ESRWintrobeReport obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is ESRWintrobeReportAdapter &&
