...
part 'esr_westergren_report.g.dart';

@HiveType(typeId: 12)
class ESRWestergrenReport implements BaseReport {
  // Common fields
  @HiveField(0)
  final String id;
  @HiveField(1)
  ...
  // Specific fields for ESR (Westergren)
  @HiveField(11)
  ...
  factory ESRWestergrenReport.fromJson(Map<String, dynamic> json) {
