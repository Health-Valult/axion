...
part of 'serum_potassium_report.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class SerumPotassiumReportAdapter extends TypeAdapter<SerumPotassiumReport> {
  @override
  final int typeId = 5;

  @override
  SerumPotassiumReport read(BinaryReader reader) {
    ...
    return SerumPotassiumReport(
      ...
      potassiumValue: fields[11] as String,
  ...
  @override
  void write(BinaryWriter writer, SerumPotassiumReport obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is SerumPotassiumReportAdapter &&
